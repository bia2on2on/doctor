...
trait Phase2MultiLocationTemporalFixture
{
    ...
    protected function purgeMultiLocationTemporalFixture(): void
    {
        global $wpdb;
        $db = App::db();
        // Order: appointments, visits, slots, schedule, clinicians, patients, locations, clinics, orgs, settings
        $tables = [
            'cpms_visit_status_history',
            'cpms_visits',
            'cpms_appointments',
            'cpms_slot_holds',
            'cpms_schedule_slots',
        ...
        // Delete appointments first via clinic filter
