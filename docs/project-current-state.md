...
This file describes the current integrated main checkpoint `440ba7e` (Phase 8 Slices 1+2 —
bounded post-merge documentation closure; see the top header block) plus the immediately
preceding `41225398` (PR #87 — Phase 8 Slice 1 public browse surface),
...
| Phase 8 | **IN PROGRESS — NOT complete (bounded post-merge documentation closure at `440ba7e7d07579036128f288f502d390d27c98d3`)** — **Slice 1 = CLOSED (BOUNDED)** via **PR #87** (MERGED 2026-09-19T20:43:04Z, merge `4122539885cadb28d69f62e765ee3368b50b0509`, approved head `0643e2b59479d73021c20508d82e20ee5bde06b5` exact-head 19/19 checks success; post-merge on the merge SHA: four required workflows terminal-success — CI `35468244421` · Real WP `35468244416` · Closure Gate `35468244423` · Pilot/Staging `35468244448`) — anonymous read-only public booking **browse** surface (explicit `clinic_id` attribute only, fail-closed; no PHI; existing A1/A4 reused; no new REST routes; no migration). **Slice 2 = CLOSED / MERGED via PR #89** (MERGED 2026-09-20T09:24:19Z, merge `440ba7e…` = current main, merge parents `41225398…` + `70d033cc…`, approved head `70d033cc3121519e882e2b18d4ada8ac1a303f81` exact-head 19/19 checks success; post-merge on the merge SHA: four required workflows terminal-success — CI `35502216463` · Real WP `35502216468` · Closure Gate `35502216456` · Pilot/Staging `35502216452` — + 19/19 check runs success) — public booking **OTP → authenticated Hold → final confirm** continuation with the **owner-issued** Hold-Timing and new-Patient minimum-identity policies (**NOT original SRS wording**; canonical record [`decisions/2026-09-20-phase8-slice2-owner-decisions.md`](decisions/2026-09-20-phase8-slice2-owner-decisions.md)); schema: **migration `2026_09_20_0021` (`cpms_otp_tokens.clinic_id`) — the latest migration on main (21 files `0001`..`0021`)**. **Slice 3 = ACTIVE in draft PR #90 only** (head `c17c965d32ec056f3e53be280173dc5182ef1c2e`; RED test-only as titled) — **not accepted, not merged, no closure claim**; migration `0022` exists **only** on that branch and is **not** main's migration. PR #88 (merge `e00cec8d…`) is a merged hardening fix — not a Phase 8 slice. No further Phase 8 slice is claimed; Phase 8 as a whole is NOT complete. This is NOT a release/V1/commercial claim |

**Integrated main checkpoint:** `440ba7e7d07579036128f288f502d390d27c98d3` (PR #89 MERGED 2026-09-20T09:24:19Z —
...
+ 19/19 check runs success; no release/V1/commercial claim). The immediately preceding main
...
closure; docs-only). Phase 8 = IN PROGRESS — NOT complete; Slice 3 active in draft PR #90 only (not accepted, not
merged). Before that:
