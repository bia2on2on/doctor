...
| **Phase 2** | **Multi-Clinic Core** | 🚧 **IN PROGRESS** — **C4/C5/C6 ✅ CLOSED** (ادغام در `origin/main` = `099b644`؛ PR #14 MERGED؛ اصلاحیهٔ پس از بستنِ C6 در `248ca10`؛ PR #17 MERGED) · **C7 ✅ MERGED** (ترمیم S1..S6؛ PR #20 MERGED 2026-09-11؛ merge = `a385d868`؛ بستن رسمی معلق تا تصمیم مالک) · **C8 🕒 NOT STARTED** (قلم بعدی Queue فاز ۲ = «Iran Location foundation»؛ scope/پذیرش تعریف‌نشده؛ شروع فقط با تأیید مالک) · وضعیت جاری: [`project-current-state.md`](../project-current-state.md) |
