...
| **Phase 2** | **Multi-Clinic Core** | 🚧 **IN PROGRESS** — **C4/C5/C6 ✅ CLOSED** (ادغام در `origin/main` = `099b644`؛ PR #14 MERGED) · **C7 🕒 NOT STARTED** (زیرفاز بعدی؛ scope تعریف‌نشده؛ شروع فقط با تأیید مالک) · وضعیت جاری: [`project-current-state.md`](../project-current-state.md) |
