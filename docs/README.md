...
> **وضعیت:** Phase 1–8 (مستندات) تأیید شد (2026-09-05) → **F1 (Core & Migrations) انجام و تأیید شد** → **F2 (احراز هویت OTP) انجام و تأیید شد** → **F2.5 (پیامک Provider-Agnostic) انجام شد** → **F3 (نوبت‌دهی/رزرو آنلاین) کامل — CI سبز** (گزارش: [`phase-reports/report-f3.md`](phase-reports/report-f3.md)) → **F4 (مراجعه/صف + Real-time + داشبورد منشی) کامل — CI سبز** (گزارش: [`phase-reports/report-f4.md`](phase-reports/report-f4.md))
