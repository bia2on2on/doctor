...
> **وضعیت:** Phase 1–8 (مستندات) تأیید شد (2026-09-05) → **F1 (Core & Migrations) انجام و تأیید شد** → **F2 (احراز هویت OTP) انجام و تأیید شد** → **F3 (نوبت‌دهی/رزرو آنلاین) پیاده‌سازی شد** — جریان B1–B6 + C/D مرتبط، Schedule API (G1)، تست‌های REST-level و همزمانی، پایپ‌لاین CI واقعی (WP 6.7 + MySQL 8) — گزارش: [`phase-reports/report-f3.md`](phase-reports/report-f3.md)
