...
| **cf290be (docs نهایی — بستن فاز)** | **34012034597** | ✅ **سبز ۵/۵** — HEAD نهایی تحویل |
...
- **DoD F7:** کد ✓ + تست‌های Integration ✓ (۱۵ تست جدید؛ کل ۲۱۸ سبز) + **CI سبز ۵/۵ (کد: run 34011934801 @ 4286aff؛ HEAD نهایی: run 34012034597 @ cf290be)** + این گزارش ✓
